<x-app-layout>
    ...
    <div class="text-gray-700 p-4">
        ...
        <div>
            <a href="{{ route('posts.index') }}" class="flex justify-center text-base leading-6 border border-gray-600 bg-white hover:bg-gray-100 text-gray-600 px-4 py-2 rounded-full mt-3">キャンセル</a>
        </div>
    </div>
